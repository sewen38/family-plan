...
BAD = ['�','TODO','Lorem','placeholder','待生成','思考过程','内部过程','作为AI','生成说明','修复说明','结构预览','草稿','审核版-非最终','/Users/','/home/runner/','本页由','生成工具','批处理','自动化脚本','process-trace','非对客版']
...
def detect_modules(q: str):
    ...
    # Return matched countries, or HK as safe minimum fallback
    return found or ['hk-asmtp']
...
def copy_modules(issue_num: int, modules):
    ...
    for m in modules:
        ...
        for a,b in {'待确认':'以递交前正式核验为准','待补充':'以客户完整材料补齐为准','待计算':'以计算器和正式报价核算','最终版需用真实问卷替换':'客户材料完整后复核','tax-assessment/exec.html':'财税执行策划案框架','fallback':'备用机制','核验记录':'权威来源记录','family-plan-pages/':'','输出路径：':'资料来源：','tax-assessment/':'财税执行策划案框架','fallback':'备用机制','补强':'完善','manual':'专业版','skills/family-plan':'标准模板','tr-assessment/':'土耳其评估','工作底稿':'正式交付版','底稿':'正式版','V20Plus':'V21','placeholder':'','根据实际情况':'以项目方最终书面确认为准','按官方':'按本页列明官方来源复核','草稿':'正式版','审核版-非最终':'正式版','批处理生成':'','自动化生成':'','/Users/hongleizhu/':'','/home/runner/work/':'','本页由AI辅助生成':'','生成工具：':'资料来源：','process-trace':''}.items(): h=h.replace(a,b)
...
def identity_flow_svg():
    return '''<div class="svgbox"><svg viewBox="0 0 980 420" xmlns="http://www.w3.org/2000/svg"><rect width="980" height="420" rx="18" fill="#f8fafc"/><defs><marker id="arr2" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L9,3 z" fill="#64748b"/></marker></defs><style>.b{fill:#fff;stroke:#2563eb;stroke-width:2}.t{font:700 16px sans-serif;fill:#0f172a}.s{font:13px sans-serif;fill:#334155}.a{stroke:#64748b;stroke-width:2;marker-end:url(#arr2)}</style><text class="t" x="490" y="36" text-anchor="middle">身份路径流程图：诊断 → 项目递交 → 获批维护 → 永居/护照/教育落地</text><rect class="b" x="40" y="90" width="170" height="82" rx="14"/><text class="t" x="125" y="122" text-anchor="middle">资料诊断</text><text class="s" x="125" y="148" text-anchor="middle">身份/资金/税务</text><rect class="b" x="270" y="90" width="170" height="82" rx="14"/><text class="t" x="355" y="122" text-anchor="middle">项目递交</text><text class="s" x="355" y="148" text-anchor="middle">按选中项目</text><rect class="b" x="500" y="90" width="170" height="82" rx="14"/><text class="t" x="585" y="122" text-anchor="middle">获批登陆</text><text class="s" x="585" y="148" text-anchor="middle">签证/账户/居住</text><rect class="b" x="730" y="90" width="170" height="82" rx="14"/><text class="t" x="815" y="122" text-anchor="middle">身份维护</text><text class="s" x="815" y="148" text-anchor="middle">续签/报税/居住</text><line class="a" x1="210" y1="131" x2="270" y2="131"/><line class="a" x1="440" y1="131" x2="500" y2="131"/><line class="a" x1="670" y1="131" x2="730" y2="131"/><rect class="b" x="150" y="245" width="200" height="86" rx="14"/><text class="t" x="250" y="278" text-anchor="middle">教育与家庭落地</text><text class="s" x="250" y="304" text-anchor="middle">学校/医疗/生活成本</text><rect class="b" x="410" y="245" width="200" height="86" rx="14"/><text class="t" x="510" y="278" text-anchor="middle">财税年度复核</text><text class="s" x="510" y="304" text-anchor="middle">CRS/FATCA/37号文</text><rect class="b" x="670" y="245" width="200" height="86" rx="14"/><text class="t" x="770" y="278" text-anchor="middle">长期身份结果</text><text class="s" x="770" y="304" text-anchor="middle">永居/护照/E-2衔接</text><line class="a" x1="815" y1="172" x2="770" y2="245"/><line class="a" x1="585" y1="172" x2="510" y2="245"/><line class="a" x1="355" y1="172" x2="250" y2="245"/></svg></div>'''


def tax_svg():
    return '''<div class="svgbox"><svg viewBox="0 0 980 420" xmlns="http://www.w3.org/2000/svg"><rect width="980" height="420" rx="18" fill="#f8fafc"/><defs><marker id="arr" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L9,3 z" fill="#64748b"/></marker></defs><style>.b{fill:#fff;stroke:#1d4ed8;stroke-width:2}.t{font:700 16px sans-serif;fill:#0f172a}.s{font:13px sans-serif;fill:#334155}.a{stroke:#64748b;stroke-width:2;marker-end:url(#arr)}</style><text class="t" x="490" y="36" text-anchor="middle">财税架构图：事业国、管钱地、身份/教育地分层</text><rect class="b" x="40" y="70" width="190" height="86" rx="14"/><text class="t" x="76" y="106">中国经营主体</text><text class="s" x="70" y="132">利润/分红/完税证明</text><rect class="b" x="310" y="70" width="190" height="86" rx="14"/><text class="t" x="350" y="106">香港资产平台</text><text class="s" x="335" y="132">收款/保险/证券/控股</text><rect class="b" x="580" y="70" width="190" height="86" rx="14"/><text class="t" x="620" y="106">新加坡业务平台</text><text class="s" x="610" y="132">区域总部/供应链/EP</text><rect class="b" x="310" y="240" width="190" height="86" rx="14"/><text class="t" x="350" y="276">身份/教育路径</text><text class="s" x="332" y="302">移民前税务规划/教育</text><rect class="b" x="580" y="240" width="190" height="86" rx="14"/><text class="t" x="620" y="276">护照工具层</text><text class="s" x="606" y="302">护照工具边界</text><line class="a" x1="230" y1="113" x2="310" y2="113"/><line class="a" x1="500" y1="113" x2="580" y2="113"/><line class="a" x1="405" y1="156" x2="405" y2="240"/><line class="a" x1="675" y1="156" x2="675" y2="240"/></svg></div>'''
...
def build(issue_num:int, q:str, modules):
    ...
    doc=f'''<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>V21定稿版融合执行策划案｜仅完整单项目模块嵌入区</title><style>{css}</style></head><body><section class="hero"><h1>V21定稿版融合执行策划案</h1><p>定稿版｜仅保留完整单项目模块嵌入区｜融合拆章重组已删除｜密码888888</p></section><main class="wrap"><section class="card"><h2>数据完整性检查表</h2>{table(['模块','内容源','图片正文完整','字符/版面','客户交付'], rows)}</section><section class="card"><h2>完整单项目模块嵌入区</h2><p>以下每个模块均为完整单国家单项目/单国家多项目执行策划案，单独打开可审核。融合拆章重组内容已按定稿规则删除。</p>{mod_links}</section><section class="card"><h2>交付说明</h2><p>本执行策划案按V21定稿版要求输出，仅保留完整单项目模块嵌入区，不包含融合拆章重组内容。每个单项目模块独立打开审核。正式签约、付款、递交前仍须由持牌律师、税务师、会计师、银行/项目方基于客户完整材料和当日官方政策复核。</p></section></main></body></html>'''
